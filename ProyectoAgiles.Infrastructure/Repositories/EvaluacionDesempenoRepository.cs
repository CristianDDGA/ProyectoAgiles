...
public class EvaluacionDesempenoRepository : Repository<EvaluacionDesempeno>, IEvaluacionDesempenoRepository
{
    ...
    {
        return await _context.Set<EvaluacionDesempeno>()
    ...
    {
        var evaluacion = await _context.Set<EvaluacionDesempeno>()
    ...
    {
        var evaluaciones = await _context.Set<EvaluacionDesempeno>()
            .Where(e => !e.IsDeleted)
            .ToListAsync();
