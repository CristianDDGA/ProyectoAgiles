...
public interface IFileService
{
    ...
    /// <summary>
    /// Guarda un archivo en el servidor manteniendo el nombre original
    /// </summary>
    /// <param name="fileBytes">Contenido del archivo en bytes</param>
    /// <param name="fileName">Nombre original del archivo</param>
    /// <param name="contentType">Tipo de contenido MIME</param>
    /// <param name="folder">Carpeta donde guardar el archivo (relativa a wwwroot)</param>
    /// <returns>Ruta relativa del archivo guardado</returns>
    Task<string> SaveFileWithOriginalNameAsync(byte[] fileBytes, string fileName, string contentType, string folder = "uploads");

    /// <summary>
    /// Obtiene la lista de tipos de contenido permitidos
    /// </summary>
    /// <returns>Lista de tipos de contenido MIME permitidos</returns>
